...
<div class="container6">
  <img src="dl1.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('PANCIT MALABON SIZE 9', 250.00)"class="img-hover-zoom img-hover-zoom--xyz" class="item">
    <img src="dl2.jpg" style="width:250px">
	<span>Product 1 - ₱250.00</span>
    <button class="btn1245633">
      <p>PANCIT&nbsp;MALABON SIZE 9</p>
      <p>250.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('PANCIT MALABON SIZE 10' , 320.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="dl2.jpg" style="width:250px">
	<span>Product 2 - ₱320.00</span>
    <button class="btn1245633">
      <p>PANCIT&nbsp;MALABON SIZE 10</p>
      <p>320.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PANCIT MALABON SIZE 12' ,500.00)">
		<img src="dl2.jpg" style="width:250px">
		<span>Product 3 - ₱500.00</span>
		<button class="btn1245633">		
		<p>PANCIT&nbsp;MALABON SIZE 12</p>
		<p>500.00&nbsp;PHP</p>
		</button>
	</div>
    <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PANCIT MALABON SIZE 14' ,820.00)">
    <img src="dl2.jpg" style="width:250px">
	<span>Product 4 - ₱820.00</span>
    <button class="btn1245633">
      <p>PANCIT&nbsp;MALABON SIZE 14</p>
      <p>820.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PANCIT MALABON SIZE 15' ,1050.00)">
    <img src="dl2.jpg" style="width:261px">
	<span>Product 5 - ₱1050.00</span>
    <button class="btn1245633">
      <p>PANCIT&nbsp;MALABON SIZE 15</p>
      <p>1050.00&nbsp;PHP</p>
    </button>
  </div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PANCIT MALABON SIZE 16' ,1150.00)">
		<img src="dl2.jpg" style="width:261px " >
		<span>Product 6 - ₱1150.00</span>
		<button class="btn1245633">		
		<p>PANCIT&nbsp;MALABON SIZE 16</p>
		<p>1150.00&nbsp;PHP</p>
		</button>
	</div>
  <div onclick="addToCart('PANCIT MALABON SIZE 18', 1400.00)" class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="dl2.jpg" style="width:261px">
	<span>Product 7 - ₱1400.00</span>
    <button class="btn1245633">
      <p>PANCIT&nbsp;MALABON SIZE 18</p>
      <p>1400.00&nbsp;PHP</p>
    </button>
  </div>
	</div>
