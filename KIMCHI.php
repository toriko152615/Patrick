...
<div class="container6">
  <img src="kc.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('COMBO A', 260.00)"class="img-hover-zoom img-hover-zoom--xyz" class="item">
    <img src="kc1.jpg" style="width:250px">
  ...
  <div onclick="addToCart('COMBO B' , 289.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="kc2.jpg" style="width:250px">
	<span>Product 2 - ₱289.00</span>
    <button class="btn1245633">
      <p>COMBO B</p>
      <p>289.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('COMBO C', 289.00)" class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="kc3.jpg" style="width:250px">
	<span>Product 3 - ₱289.00</span>
    <button class="btn1245633">
      <p>COMBO C</p>
      <p>289.00&nbsp;PHP</p>
    </button>
  </div>
    <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('COMBO D' ,289.00)">
    <img src="kc4.jpg" style="width:250px">
	<span>Product 4 - ₱289.00</span>
    <button class="btn1245633">
      <p>COMBO D</p>
      <p>289.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('COMBO E' ,220.00)">
    <img src="kc5.jpg" style="width:261px">
	<span>Product 5 - ₱220.00</span>
    <button class="btn1245633">
      <p>COMBO E</p>
      <p>220.00&nbsp;PHP</p>
    </button>
  </div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('BRAZO ROLL SLICE' ,169.00)">
		<img src="kc6.jpg" style="width:261px " >
		<span>Product 6 - ₱169.00</span>
		<button class="btn1245633">		
		<p>BENTO B</p>
		<p>169.00&nbsp;PHP</p>
		</button>
	</div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PORK PORKGOGI' ,80.00)">
		<img src="kc7.jpg" style="width:261px">
	...
	<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('BENTO C',149.00)">
		<img src="kc8.jpg" style="width:261px">
		<span>Product 8 - ₱149.00</span>
		<button class="btn1245633">		
		<p>BENTO C</p>
		<p>149.00&nbsp;PHP</p>
		</button>
	</div>
	<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('KIMCHI BULGOGI',115.00)">
		<img src="kc9.jpg" style="width:250px">
		<span>Product 9 - ₱115.00</span>
		<button class="btn12456">		
		<p>KIMCHI BULGOGI</p>
		<p>115.00&nbsp;PHP</p>
		</button>
	</div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('CHICKEN BOWL',79.00)">
		<img src="kc10.jpg" style="width:250px" >
...
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('KIMCHI RICE SPAM',130.00)">
		<img src="kc11.jpg" style="width:250px">
		<span>Product 11 - ₱130.00</span>
		<button class="btn1245633">		
		<p>KIMCHI&nbsp;RICE SPAM</p>
		<p>130.00&nbsp;PHP</p>
		</button>
	</div>
	</div>
