...
<div class="container6">
  <img src="BI.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('CHICKEN LEG', 119.00)"class="img-hover-zoom img-hover-zoom--xyz" class="item">
    <img src="BI1.jpg" style="width:250px">
  ...
  <div onclick="addToCart('CHICKEN BREAST' , 99.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="BI2.jpg" style="width:250px">
	<span>Product 2 - ₱99.00</span>
    <button class="btn12456">
      <p>CHICKEN&nbsp;BREAST</p>
      <p>99.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('MILKFISH', 169.00)" class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="BI3.jpg" style="width:250px">
	<span>Product 3 - ₱169.00</span>
    <button class="btn12456">
      <p>MILKFISH</p>
      <p>169.00&nbsp;PHP</p>
    </button>
  </div>
    <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PORK BELLY' ,169.00)">
    <img src="BI4.jpg" style="width:250px">
	<span>Product 4 - ₱169.00</span>
    <button class="btn1245633">
      <p>PORK&nbsp;BELLY</p>
      <p>169.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('MIXED DESSERT' ,85.00)">
    <img src="BI5.jpg" style="width:261px">
...
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('BOTTLE OF ICE TEA' ,15.00)">
		<img src="BI6.jpg" style="width:261px " >
		<span>Product 6 - ₱15.00</span>
		<button class="btn1245633">		
		<p>BOTTLE&nbsp;OF ICE&nbsp;TEA</p>
		<p>15.00&nbsp;PHP</p>
		</button>
	</div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PITCHER OF ICED TEAA' ,65.00)">
		<img src="BI7.jpg" style="width:261px">
		<span>Product 7 - ₱65.00</span>
		<button class="btn1245633">		
		<p>PITCHER&nbsp;OF ICED&nbsp;TEA</p>
		<p>65.00&nbsp;PHP</p>
		</button>
	</div>
	</div>
