...
<div class="container6">
  <img src="bbt.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('MINI DONUT SAUCE', 20.00)"class="img-hover-zoom img-hover-zoom--xyz" class="item">
    <img src="bbt1.jpg" style="width:250px">
	<span>Product 1 - ₱20.00</span>
    <button class="btn1245633">
      <p>MINI&nbsp;DONUT SAUCE</p>
      <p>20.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('MINI DONUT TOPPINGS' , 20.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="bbt2.jpg" style="width:250px">
	<span>Product 2 - ₱20.00</span>
    <button class="btn1245633">
      <p>MINI&nbsp;DONUT TOPPINGSN</p>
      <p>20.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('CLASSIC DONUTS', 55.00)" class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="bbt3.jpg" style="width:250px">
  ...
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('DOZEN DONUTS' ,95.00)">
    <img src="bbt4.jpg" style="width:250px">
	<span>Product 4 - ₱95.00</span>
    <button class="btn1245633">
      <p>DOZEN DONUTS</p>
      <p>95.00&nbsp;PHP</p>
    </button>
  </div>
      <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('BUNCH DONUTS ' ,185.00)">
    <img src="bbt5.jpg" style="width:250px">
	<span>Product 5 - ₱185.00</span>
    <button class="btn12456">
      <p>BUNCH DONUTS </p>
      <p>185.00&nbsp;PHP</p>
    </button>
