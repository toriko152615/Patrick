...
<div class="container6">
  <img src="s1.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('1-2 PAX' , 549.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="s2.jpg" style="width:250px">
	<span>Product 2 - ₱549.00</span>
    <button class="btn1245633">
      <p>1-2<br>PAX</p>
      <p>549.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('1-3 PAX' ,850.00)">
		<img src="s3.jpg" style="width:250px">
		<span>Product 3 - ₱850.00</span>
		<button class="btn1245633">		
		<p>1-3<br>PAX</p>
		<p>850.00&nbsp;PHP</p>
		</button>
	</div>
    <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('3-5 PAX' ,1499.00)">
    <img src="s4.jpg" style="width:250px">
	<span>Product 4 - ₱1499.00</span>
    <button class="btn1245633">
      <p>3-5<br>PAX</p>
      <p>1499.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('5-8 PAX' ,2299.00)">
    <img src="s5.jpg" style="width:261px">
	<span>Product 5 - ₱2299.00</span>
    <button class="btn1245633">
      <p>5-8 PAX</p>
      <p>2299.00&nbsp;PHP</p>
    </button>
  </div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('8-10 PAX' ,2699.00)">
		<img src="s6.jpg" style="width:261px " >
		<span>Product 6 - ₱2699.00</span>
		<button class="btn1245633">		
		<p>8-10 PAX</p>
		<p>2699.00&nbsp;PHP</p>
		</button>
