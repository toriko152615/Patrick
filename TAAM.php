...
<div class="container6">
  <img src="TAAM.jpg"  width="100%" height="600px">
</div>
	<div  id="products" class="grid-container">
  <div onclick="addToCart('CHICKSITAP', 350.00)"class="img-hover-zoom img-hover-zoom--xyz" class="item">
    <img src="T1.jpg" style="width:250px">
	<span>Product 1 - ₱350.00</span>
    <button class="btn1245633">
      <p>CHICKEN&nbsp;PIYAPARAN</p>
      <p>350.00&nbsp;PHP</p>
    </button>
  </div>
  <div onclick="addToCart('CRISPY FISH FILLET' , 300.00)"  class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="T2.jpg" style="width:250px">
	<span>Product 2 - ₱300.00</span>
    <button class="btn1245633">
      <p>CRISPY&nbsp;FISH&nbsp;FILLET</p>
      <p>300.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('CHICKEN KATSUDON' ,400.00)">
		<img src="T7.jpg" style="width:250px">
		<span>Product 3 - ₱400.00</span>
		<button class="btn1245633">		
		<p>CHICKEN&nbsp;KATSUDON</p>
		<p>400.00&nbsp;PHP</p>
		</button>
	</div>
    <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('CARA BEEF KEBAB' ,450.00)">
    <img src="T4.jpg" style="width:250px">
	<span>Product 4 - ₱450.00</span>
    <button class="btn1245633">
      <p>CARA&nbsp;BEEF&nbsp;KEBAB</p>
      <p>450.00&nbsp;PHP</p>
    </button>
  </div>
  <div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('CHICKEN AND TOFU SISIG' ,400.00)">
    <img src="T5.jpg" style="width:261px">
	<span>Product 5 - ₱400.00</span>
    <button class="btn1245633">
      <p>CHICKEN&nbsp;AND&nbsp;TOFU&nbsp;SISIG</p>
      <p>400.00&nbsp;PHP</p>
    </button>
  </div>
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('TAAM BUTTERED SHRIMP' ,450.00)">
		<img src="T6.jpg" style="width:261px " >
		<span>Product 6 - ₱450.00</span>
		<button class="btn1245633">		
		<p>TAAM&nbsp;BUTTERED&nbsp;SHRIMP</p>
		<p>450.00&nbsp;PHP</p>
		</button>
	</div>
  <div onclick="addToCart('SOY GARLIC CHICKEN', 300.00)" class="img-hover-zoom img-hover-zoom--xyz" class="item" >
    <img src="T3.jpg" style="width:261px">
	<span>Product 7 - ₱300.00</span>
    <button class="btn1245633">
      <p>SOY&nbsp;GARLIC&nbsp;CHICKEN</p>
      <p>300.00&nbsp;PHP</p>
    </button>
  </div>
	<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('TAPSIHOT OR LONG',300.00)">
		<img src="T8.jpg" style="width:261px">
		<span>Product 8 - ₱300.00</span>
		<button class="btn1245633">		
		<p>SPICY&nbsp;SCHEZUAN&nbsp;CHICKEN</p>
		<p>300.00&nbsp;PHP</p>
		</button>
	</div>
	<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('CHICKSIHOT OR LONG',100.00)">
		<img src="T9.jpg" style="width:250px">
		<span>Product 9 - ₱300.00</span>
		<button class="btn1245633">		
		<p>TAAM&nbsp;PALAPA</p>
		<p>1799.00&nbsp;PHP</p>
		</button>
...
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('PORKSIHOT OR LONG',100.00)">
		<img src="T10.jpg" style="width:250px" >
...
<div class="img-hover-zoom img-hover-zoom--xyz" class="item" onclick="addToCart('LIEMPOSIHOT OR LONG',1699.00)">
		<img src="T11.jpg" style="width:250px">
		<span>Product 11 - ₱1699.00</span>
		<button class="btn1245633">		
		<p>TAAM&nbsp;PALAPA</p>
		<p>1699.00&nbsp;PHP</p>
		</button>
